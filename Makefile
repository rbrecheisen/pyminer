...
coverage:
	coverage run --source pyminer setup.py test
	coverage report -m
	coverage html
	@echo "To view results type: htmlcov/index.html &"

docs:
	rm -f docs/pyminer.rst
	rm -f docs/modules.rst
	sphinx-apidoc -f -o docs/ pyminer
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
install: dist
	pip install --upgrade --no-deps --force-reinstall dist/pyminer-*.tar.gz

uninstall: 
	pip uninstall -y pyminer
